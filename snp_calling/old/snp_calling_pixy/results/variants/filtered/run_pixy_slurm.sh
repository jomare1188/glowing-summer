...
pixy   --vcf cohort.allsites.filtered.vcf.gz   --populations  populations.txt  --window_size 10000   --n_cores 50  --output_prefix pixy_out --stats pi --output_folder pixy_out
